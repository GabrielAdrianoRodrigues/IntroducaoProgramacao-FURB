...
public class Uni6Exe10 {
	...
	private Uni6Exe10() {
		...
		do {
			...
			switch (opcao) {
				case 1:
					posFim = valorIncluir(vet, posFim, imput);
					break;
				case 2:
					valorPesquisar(vet, posFim, imput);
					break;
				case 3:
					valorAlterar(vet, posFim, imput);
					break;
				case 4:
					posFim = valorExcluir(vet, posFim, imput);
					break;
				case 5:
	...
	public int valorIncluir(int vet[], int posFim, Scanner imput) {
		if (posFim < vet.length) {
			System.out.print(" valor: ");
			vet[posFim] = imput.nextInt();
			posFim++;
	...
	public int valorPesquisar(int vet[], int posFim, Scanner imput) {
	...
	public void valorAlterar(int vet[], int posFim, Scanner imput) {
		int valorId = valorPesquisar(vet, posFim, imput);
		if (valorId != -1) {
			System.out.print(" valor troca: ");
			vet[valorId] = imput.nextInt();
			System.out.println("_ valor troca vet[" + valorId + "]: " + vet[valorId]);
		}
	}

	public int valorExcluir(int vet[], int posFim, Scanner imput) {
		int valorId = valorPesquisar(vet, posFim, imput);
		if (valorId != -1) {
